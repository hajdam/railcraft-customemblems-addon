...
public class TileCustomEngravingBench extends TileMachineItem implements IEnergyHandler, ISidedInventory, IHasWork, IGuiReturnHandler {
    ...
    public TileCustomEngravingBench() {
        super(2);
    ...
    public IEnumMachine getMachineType() {
        return EnumMachine.CUSTOM_ENGRAVING_BENCH;
    }
    ...
    public void readGuiData(DataInputStream data, EntityPlayer sender) throws IOException {
        ...
        switch (type) {
            ...
            case NORMAL_RETURN:
                ...
                break;
            case OPEN:
                GuiHandler.openGui(EnumGui.CUSTOM_ENGRAVING_BENCH, sender, worldObj, xCoord, yCoord, zCoord);
                break;
        }
    }
    ...
    public boolean openGui(EntityPlayer player) {
        ...
        GuiHandler.openGui(EnumGui.CUSTOM_ENGRAVING_BENCH, player, worldObj, xCoord, yCoord, zCoord);
        return true;
    }
    ...
    private ItemStack makeEmblem() {
        if (currentEmblem == null || currentEmblem.isEmpty()) {
            return null;
        }
        
        if (CustomEmblemUtils.isCustom(currentEmblem)) {
            return CustomItemEmblem.getEmblem(currentEmblem);
        }
